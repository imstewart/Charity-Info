...
$file_location = "\\192.168.0.115\samba\Turing Apps\Settings\turing"
...
Function RegSetUser {
	...
	reg add HKLM\SOFTWARE\Software\Policies\Microsoft\MicrosoftEdge\Main /v PreventFirstRunPage /t REG_DWORD /d 1 /f
  ...
  <DefaultLayoutOverride>
    <StartLayoutCollection>
      <defaultlayout:StartLayout GroupCellWidth="6">
        <start:Group Name="Turing Applications">
          <start:DesktopApplicationTile Size="2x2" Column="4" Row="0" DesktopApplicationLinkPath="%ALLUSERSPROFILE%\Microsoft\Windows\Start Menu\Programs\VideoLAN\VLC media player.lnk" />
          <start:DesktopApplicationTile Size="2x2" Column="2" Row="2" DesktopApplicationLinkPath="%APPDATA%\Microsoft\Windows\Start Menu\Programs\RapidTyping.lnk" />
          <start:DesktopApplicationTile Size="2x2" Column="0" Row="0" DesktopApplicationLinkPath="%ALLUSERSPROFILE%\Microsoft\Windows\Start Menu\Programs\LibreOffice 7.2\LibreOffice.lnk" />
          ...
          <start:DesktopApplicationTile Size="2x2" Column="2" Row="0" DesktopApplicationLinkPath="%APPDATA%\Microsoft\Windows\Start Menu\Programs\Scratch 3.lnk" />
        </start:Group>
...
"@
        md c:\turing -Force
	    add-content c:\turing\startlayout.xml $StartLayoutStr
        import-startlayout -layoutpath c:\turing\startlayout.xml -mountpath $Env:SYSTEMDRIVE\
